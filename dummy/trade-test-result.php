...
<div class="container" style="border: 1px solid #ececec;padding: 100px; background: #fbfbfb;">
	<div class="row">
        ...
        <div class="col-md-6">
            ...
            <fieldset><legend class="text-center" style="border: 1px solid #bbb9b9;background: #ecf6ff;font-weight: bold; color: #4a5204;">Search here for Trade Test result<span class="req"></span></legend>
