...
<ul class="dropdown-menu">
      <li class="dropdown-submenu">
        <a class="test" tabindex="-1" href="#">Long Courses Result <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a tabindex="-1" href="#">Computer Trade</a></li>
          <li><a tabindex="-1" href="#">Electrical Trade</a></li>
          <li><a tabindex="-1" href="#">Refrigeration Trade</a></li>
          <li><a tabindex="-1" href="#">Motorcycle Trade</a></li>
          
        </ul>
      </li>
      <li class="dropdown-submenu">
        <a class="test" tabindex="-1" href="#">Short Courses Result <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a tabindex="-1" href="#">Computer Trade</a></li>
          <li><a tabindex="-1" href="#">Electrical Trade</a></li>
          <li><a tabindex="-1" href="#">Refrigeration Trade</a></li>
                        ...
                        <div class="tab-content">
                          <div class="tab-pane active" id="men">
                            <ul class="nav-list list-inline">
                                ...
                                <li><a href="library.php"><img src="dist-img/menu/h.jpg" class="img-responsive" alt=""/><p style="color: #000;">Library</p></a></li>
                            </ul>
                          </div>
