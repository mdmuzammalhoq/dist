...
<?php 
  ...
  <tbody>
    <button class="btn btn-warning btn-block hdr">DIST Online Result (Short Course)</button>
    <tr>
...
?>
        ...
        <div class="col-md-6">
            ...
            <fieldset><legend class="text-center" style="border: 1px solid #bbb9b9;background: #ecf6ff;font-weight: bold; color: #4a5204;">Search here for short Course result<span class="req"></span></legend>
